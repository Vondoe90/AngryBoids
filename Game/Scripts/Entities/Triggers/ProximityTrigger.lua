...
function ProximityTrigger:OnReset()
  ...
  -- precalcs some vars used to test trigering entities based in their names. ("selectedEntity" is a totally misleading name for all this...but i wont change that)
